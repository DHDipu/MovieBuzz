    ...
    <header>
      <nav className="bg-white border-b-2 border-gray-200 dark:bg-gray-900 ">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            <img src={Logo} className="h-8" alt="MovieBuzz" />
          ...
          <div id="mobile-nav" className="flex md:order-2">
            ...
            <button
              ...
              className="text-gray-500 inline-flex items-center justify-center dark:text-gray-400 hover:bg-gray-100 w-9 h-9 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-1.5 mx-3"
            >
